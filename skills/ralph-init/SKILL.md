...
6. If `docs/prd/` is missing entirely, copy modular PRD skeletons from `templates/docs/prd/` (`README.md`, `00-macro-shared.md`, `modules/M01-example.md`, `grill-signoff.md` as **draft**) and tell the user to run **`/prd-author`**
...
8. Create `.ralph-security` sign-off
9. Update `.gitignore` for `.ralph-logs/`, `.ralph-stop`, `.scratch/`
