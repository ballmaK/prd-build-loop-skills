...
6. If `docs/prd/` exists and `docs/prd/grill-signoff.md` is missing, copy `templates/docs/prd/grill-signoff.md` as a **draft** placeholder (do not set `approved`)
7. Create `.ralph-security` sign-off
8. Update `.gitignore` for `.ralph-logs/`, `.ralph-stop`, `.scratch/`
